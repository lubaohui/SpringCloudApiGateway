...
public class FreeMarkerTests extends BasicUtClass{
	...
	public void saveToFile() throws Exception {
		...
		String relativelyPath=System.getProperty("user.dir") + "/outhtml";
		//System.out.println("relativelyPath is : " + relativelyPath);
		logger.debug("relativelyPath is : {}" ,relativelyPath);
		...
		File path = new File(relativelyPath);
		if(!path.exists()){
			path.mkdirs();
		}
